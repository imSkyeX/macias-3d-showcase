...
import { Download, Cpu, PenTool, Lightbulb } from "lucide-react"; // Importamos iconos extra
...
const About = () => {
  ...
  const softwareStack = [
    { name: "CATIA", icon: "src/assets/icons/dassault-catia.svg" },
    { name: "SOLIDWORKS", icon: "src/assets/icons/solidworks-logo-1.svg" },
    { name: "Blender", icon: "src/assets/icons/blender.svg" },
    { name: "Illustrator", icon: "src/assets/icons/adobeillustrator.svg" },
    { name: "Photoshop", icon: "src/assets/icons/adobe-photoshop-logo.svg" },
    { name: "After Effects", icon: "src/assets/icons/aftereffects.svg" },
    { name: "React", icon: "src/assets/icons/react-native-1.svg" }
  ];
  ...
  return (
    // CAMBIO: Aumentado ligeramente el padding top en móvil (pt-32 a pt-36) para asegurar que libra el menú
    <div className="min-h-screen bg-white/5 backdrop-blur-xl text-white pt-36 md:pt-32 pb-20">
      <div className="container mx-auto px-5 md:px-4">
        
        {/* CAMBIO CLAVE: flex-col-reverse hace que el texto salga arriba en móvil y la foto abajo. En PC (md:flex-row) se mantiene foto izq, texto der. */}
        <div className="flex flex-col md:flex-row items-start gap-12 max-w-6xl mx-auto mb-20">
          ...
          <motion.div 
            ...
            // CAMBIO CLAVE: Quitamos 'sticky' general. Ahora es 'relative' en móvil, y 'md:sticky md:top-32' solo en PC.
          ...
          <motion.div 
            ...
            // CAMBIO: p-6 en móvil en vez de p-8 para ganar espacio de lectura
          ...
          >
            ...
            <div className="flex flex-wrap gap-2 md:gap-3 mb-10">
              {skills.map((skill, index) => (
                <span 
                  key={index} 
                  className="px-3 md:px-4 py-2 bg-[#494949] text-white text-xs md:text-sm rounded-full border border-[#848484] hover:border-[#ff9500] transition-colors cursor-default"
                >
                  {skill}
                </span>
              ))}
              ...
              {softwareStack.map((software, index) => (
                ...
                >
                  <img 
                    ...
                    onError={(e) => { (e.target as HTMLImageElement).src = 'https://via.placeholder.com/40/333333/FFFFFF?text=ICON'; }}
                  />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-[#1e1e1e]/80 p-8 rounded-2xl border border-white/5 hover:border-orange-500/50 transition-colors">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Applying advanced concepts like computational dynamics and structural analysis to ensure that every 3D model is not only visually stunning but physically viable and mechanically precise.
              </p>
            </div>
            ...
            <div className="bg-[#1e1e1e]/80 p-8 rounded-2xl border border-white/5 hover:border-orange-500/50 transition-colors">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Translating complex engineering data into clear, aesthetically refined renders and graphic identities that communicate value to both technical and non-technical audiences.
              </p>
            </div>
            ...
            <div className="bg-[#1e1e1e]/80 p-8 rounded-2xl border border-white/5 hover:border-orange-500/50 transition-colors">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Bridging the gap between creative design and industrial manufacturing. Finding the optimal balance between form, function, and production feasibility.
              </p>
            </div>
